...
bool SRPGScene::init()
{
    ...
    // グリッド表示/非表示
    auto pMenuItem1 = MenuItemLabel::create(LabelTTF::create("A", "", 24), [this](Ref *pSender) {
        //ログ出力
    ...
    auto pMenuItem2 = MenuItemLabel::create(LabelTTF::create("B", "", 24), [this](Ref *pSender) {
        //ログ出力
    ...
    auto pMenuItem3 = MenuItemLabel::create(LabelTTF::create("C", "", 24), [this](Ref *pSender) {
        //ログ出力
